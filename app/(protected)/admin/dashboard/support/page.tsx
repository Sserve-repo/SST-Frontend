...
export default function SupportPage() {
      ...
      messages: [
        {
          id: "1",
          sender: "user",
          content: "I've been trying to log in but keep getting an error message.",
    ...
    },
    {
      ...
      messages: [
        ...
        },
        {
          id: "2",
          sender: "admin",
          content: "I'll look into this right away. Could you please provide the reason for the refund?",
      ...
      internalNotes: [
        {
          id: "1",
          author: "John Admin",
          content: "Customer has a valid reason for refund. Processing request.",
    ...
    },
    {
      ...
      messages: [
        ...
        },
        {
          id: "2",
          sender: "admin",
          content: "Thank you for the suggestion! We'll add this to our feature request list.",
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-primary sm:text-3xl">Support Dashboard</h1>
