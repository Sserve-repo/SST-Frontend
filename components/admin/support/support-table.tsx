              ...
              <TableRow key={ticket.id}>
                ...
                <TableCell>
                  <Badge
                    ...
                    className={cn(
                      "capitalize",
                      ticket.type === "technical" && "bg-blue-100 text-blue-600",
                      ticket.type === "billing" && "bg-yellow-100 text-yellow-600",
                      ticket.type === "feature_request" && "bg-purple-100 text-purple-600",
                      ticket.type === "general" && "bg-gray-100 text-gray-600",
                    )}
                  >
                ...
                <TableCell>
                  <Badge
                    ...
                    className={cn(
                      ...
                      ticket.priority === "low" && "bg-green-100 text-green-600",
                    )}
                  >
                    {ticket.priority}
                  </Badge>
