...
// //           Featured Product
// //         </h2>
// //         <div className=" rounded-2xl p-4 md:p-7">
...
//       return;
//     }
//     router.push(`/products/${name.replace(/\s+/g, "-").toLowerCase()}`);
//   };
...
//               onMouseEnter={() => setHoveredCard(product.id as any)}
...
export default function FeaturedProducts() {
  ...
  const fetchFeaturedProducts = async () => {
    try {
      const response = await fetch(`${API_BASE_URL}/general/featuredProducts`);
