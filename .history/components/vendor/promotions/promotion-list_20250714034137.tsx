...
//       <EditPromotionDialog
//         promotion={promotionToEdit as any ?? null}
    ...
    <>
      ...
      <EditPromotionDialog
        promotion={promotionToEdit ? {
          ...
          name: promotionToEdit.discount_name,
          code: undefined,
          type: promotionToEdit.discount_type,
          value: parseFloat(promotionToEdit.discount_value),
          startDate: new Date(promotionToEdit.start_date),
          endDate: new Date(promotionToEdit.end_date),
          status: promotionToEdit.status as "active" | "expired" | "upcoming" | "disabled",
          usageLimit: promotionToEdit.usage_limit,
          usageCount: promotionToEdit.usage_count ?? 0,
          description: promotionToEdit.description,
          createdAt: new Date(promotionToEdit.created_at),
          updatedAt: new Date(promotionToEdit.updated_at),
        }as any : null}
        open={promotionToEdit !== null}
        onOpenChange={(open) => !open && setPromotionToEdit(null)}
        onSuccess={() => {
          if (promotionToEdit) {
            onUpdate(promotionToEdit.id, new FormData()); // You may need to adjust this based on your actual implementation
          }
          setPromotionToEdit(null);
        }}
      />
