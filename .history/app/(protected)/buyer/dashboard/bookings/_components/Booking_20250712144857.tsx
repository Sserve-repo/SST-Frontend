...
const handleFetchBookings = async (params: FilterParams = {}, isReset = false) => {
    setLoading(true);
    try {
    ...
    const finalParams = isReset ? params : { ...filters, ...params };
      ...
      if (response.ok) {
        ...
        console.log("bybybyby ububububub", data?.data?.orders);
  ...
  const handleStatusFilterChange = (value: string) => {
    const newFilters = { ...filters, booking_status: value, page: 1 };
    setFilters(newFilters);
    handleFetchBookings(newFilters);
  };
  ...
  const handleResetFilters = () => {
    ...
    setCustomDateRange({ start_date: "", end_date: "" });
    setShowCustomDate(false);
  handleFetchBookings(resetFilters, true); // Pass true to indicate it's a reset
  };
                  ...
                  <TableCell colSpan={9} className="text-center py-8">
                    <div className="text-gray-500">
                      ...
                      filters.booking_status
                        ? "No booking found matching your criteria"
                        : "No booking found"}
                    </div>
                  </TableCell>
                </TableRow>
